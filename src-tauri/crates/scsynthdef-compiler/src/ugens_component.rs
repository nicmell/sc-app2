...
use super::bindings::exports::scsynthdef::compiler::ugens::{
    A2KArgs, AllpassCArgs, AllpassLArgs, AllpassNArgs, AmpCompAArgs, AmpCompArgs, AmplitudeArgs,
    ApfArgs, BAllPassArgs, BBandPassArgs, BBandStopArgs, BHiPassArgs, BHiShelfArgs, BLowPassArgs,
    BLowShelfArgs, BPeakEqArgs, Balance2Args, BallArgs, BeatTrack2Args, BeatTrackArgs, BiPanB2Args,
    BlipArgs, BpfArgs, Bpz2Args, BrfArgs, Brz2Args, BufAllpassCArgs, BufAllpassLArgs,
    BufAllpassNArgs, BufChannelsArgs, BufCombCArgs, BufCombLArgs, BufCombNArgs, BufDelayCArgs,
    BufDelayLArgs, BufDelayNArgs, BufDurArgs, BufFramesArgs, BufRateScaleArgs, BufRdArgs,
    BufSampleRateArgs, BufSamplesArgs, BufWrArgs, COscArgs, CheckBadValuesArgs, ClearBufArgs,
    ClipArgs, CoinGateArgs, CombCArgs, CombLArgs, CombNArgs, CompanderArgs, Convolution2Args,
    Convolution2LArgs, Convolution3Args, ConvolutionArgs, CrackleArgs, CuspLArgs, CuspNArgs,
    DbrownArgs, DbufrdArgs, DbufwrArgs, DcArgs, Decay2Args, DecayArgs, DecodeB2Args,
    DegreeToKeyArgs, DelTapRdArgs, DelTapWrArgs, Delay1Args, Delay2Args, DelayCArgs, DelayLArgs,
    DelayNArgs, DemandArgs, DemandEnvGenArgs, DetectIndexArgs, DetectSilenceArgs, DgeomArgs,
    DibrownArgs, DiskInArgs, DiskOutArgs, DiwhiteArgs, DonceArgs, DoneArgs, DpollArgs, DrandArgs,
    DseqArgs, DserArgs, DseriesArgs, DshufArgs, DstutterArgs, Dswitch1Args, DswitchArgs, Dust2Args,
    DustArgs, DutyArgs, DwhiteArgs, DxrandArgs, EnvGenArgs, ExpRandArgs, FSinOscArgs, FbSineCArgs,
    FbSineLArgs, FbSineNArgs, FftArgs, FftTriggerArgs, FoldArgs, FormantArgs, FormletArgs, FosArgs,
    FreeArgs, FreeSelfArgs, FreeSelfWhenDoneArgs, FreeVerb2Args, FreeVerbArgs, FreqShiftArgs,
    GVerbArgs, GateArgs, GbmanLArgs, GbmanNArgs, Gendy1Args, Gendy2Args, Gendy3Args, GrainBufArgs,
    GrainFmArgs, GrainInArgs, GrainSinArgs, Guest as UgensGuest, HasherArgs, HenonCArgs,
    HenonLArgs, HenonNArgs, HilbertArgs, HpfArgs, Hpz1Args, Hpz2Args, IEnvGenArgs, IRandArgs,
    IfftArgs, ImpulseArgs, InArgs, InFeedbackArgs, InRangeArgs, InRectArgs, InTrigArgs, IndexArgs,
    IndexInBetweenArgs, IntegratorArgs, K2AArgs, KeyStateArgs, KeyTrackArgs, KlangArgs, KlankArgs,
    Lag2Args, Lag2UdArgs, Lag3Args, Lag3UdArgs, LagArgs, LagInArgs, LagUdArgs, LastValueArgs,
    LatchArgs, LatoocarfianCArgs, LatoocarfianLArgs, LatoocarfianNArgs, LeakDcArgs,
    LeastChangeArgs, LfClipNoiseArgs, LfCubArgs, LfGaussArgs, LfNoise0Args, LfNoise1Args,
    LfNoise2Args, LfParArgs, LfPulseArgs, LfSawArgs, LfTriArgs, LfdClipNoiseArgs, LfdNoise0Args,
    LfdNoise1Args, LfdNoise3Args, LimiterArgs, LinCongCArgs, LinCongLArgs, LinCongNArgs,
    LinExpArgs, LinPan2Args, LinRandArgs, LinXFade2Args, LineArgs, LinenArgs, LocalBufArgs,
    LocalInArgs, LocalOutArgs, LogisticArgs, LorenzLArgs, LoudnessArgs, LpfArgs, Lpz1Args,
    Lpz2Args, MantissaMaskArgs, MaxLocalBufsArgs, MedianArgs, MfccArgs, MidEqArgs, MoogFfArgs,
    MostChangeArgs, MouseButtonArgs, MouseXArgs, MouseYArgs, MulAddArgs, NRandArgs, NormalizerArgs,
    OffsetOutArgs, OnePoleArgs, OneZeroArgs, OnsetsArgs, OscArgs, OutArgs, PSinGrainArgs, Pan2Args,
    Pan4Args, PanAzArgs, PanB2Args, PanBArgs, PartConvArgs, PauseArgs, PauseSelfArgs,
    PauseSelfWhenDoneArgs, PeakArgs, PeakFollowerArgs, PhasorArgs, PitchArgs, PitchShiftArgs,
    PlayBufArgs, PluckArgs, PollArgs, PulseArgs, PulseCountArgs, PulseDividerArgs, PvAddArgs,
    PvBinScrambleArgs, PvBinShiftArgs, PvBinWipeArgs, PvBrickWallArgs, PvConformalMapArgs,
    PvConjArgs, PvCopyArgs, PvCopyPhaseArgs, PvDiffuserArgs, PvDivArgs, PvHainsworthFooteArgs,
    PvJensenAndersenArgs, PvLocalMaxArgs, PvMagAboveArgs, PvMagBelowArgs, PvMagClipArgs,
    PvMagDivArgs, PvMagFreezeArgs, PvMagMulArgs, PvMagNoiseArgs, PvMagShiftArgs, PvMagSmearArgs,
    PvMagSquaredArgs, PvMaxArgs, PvMinArgs, PvMulArgs, PvPhaseShift270Args, PvPhaseShift90Args,
    PvPhaseShiftArgs, PvRandCombArgs, PvRandWipeArgs, PvRectComb2Args, PvRectCombArgs, QuadCArgs,
    QuadLArgs, QuadNArgs, RampArgs, RandArgs, RandIdArgs, RandSeedArgs, Rate as WitRate,
    RecordBufArgs, ReplaceOutArgs, ResonzArgs, RhpfArgs, RingzArgs, RlpfArgs, Rotate2Args,
    RunningMaxArgs, RunningMinArgs, RunningSumArgs, SawArgs, SchmidtArgs, ScopeOut2Args,
    ScopeOutArgs, SelectArgs, SendReplyArgs, SendTrigArgs, SetBufArgs, SetResetFfArgs, ShaperArgs,
    SharedInArgs, SharedOutArgs, SilentArgs, SinOscArgs, SinOscFbArgs, SlewArgs, SlopeArgs,
    SosArgs, SpecCentroidArgs, SpecFlatnessArgs, SpecPcileArgs, SpringArgs, StandardLArgs,
    StandardNArgs, StepperArgs, StereoConvolution2LArgs, SweepArgs, SyncSawArgs, SynthDefBorrow,
    T2AArgs, T2KArgs, TBallArgs, TDelayArgs, TDutyArgs, TExpRandArgs, TGrainsArgs, TRandArgs,
    TWindexArgs, TiRandArgs, TimerArgs, ToggleFfArgs, TrapezoidArgs, Trig1Args, TrigArgs,
    TwoPoleArgs, TwoZeroArgs, UgenInput as WitUgenInput, VDiskInArgs, VOsc3Args, VOscArgs,
    VarSawArgs, VibratoArgs, Warp1Args, WrapArgs, WrapIndexArgs, XFade2Args, XLineArgs, XOutArgs,
    ZeroCrossingArgs,
};
use super::{rate_from_wit, ugen_input_from_wit, ugen_input_to_wit, Component, SynthDefResource};
use crate::UGenInput;
...
impl UgensGuest for Component {
    ...
    fn a2_k(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: A2KArgs) -> WitUgenInput {
        let in_ = args
            ...
            .unwrap_or(UGenInput::Constant(0.0));
    ...
    fn allpass_c(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: AllpassCArgs) -> WitUgenInput {
        let in_ = args
            ...
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.0));
        let max_delay_time = args
            .max_delay_time
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.2));
        let delay_time = args
            .delay_time
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.2));
        let decay_time = args
            .decay_time
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.0));
    ...
    fn amp_comp(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: AmpCompArgs) -> WitUgenInput {
        let freq = args
            .freq
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(261.6256));
        let root = args
            .root
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(261.6256));
        let exp = args
            .exp
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.3333));
    ...
    fn amp_comp_a(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: AmpCompAArgs) -> WitUgenInput {
        let freq = args
            .freq
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1000.0));
        let root = args
            .root
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.0));
        let min_amp = args
            .min_amp
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.32));
        let root_amp = args
            .root_amp
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.0));
    ...
    fn amplitude(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: AmplitudeArgs) -> WitUgenInput {
        let in_ = args
            ...
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.0));
        let attack_time = args
            .attack_time
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.01));
        let release_time = args
            .release_time
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.01));
    ...
    fn apf(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: ApfArgs) -> WitUgenInput {
        ...
        let freq = args
            .freq
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(440.0));
        let radius = args
            .radius
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.8));
    ...
    fn b_all_pass(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: BAllPassArgs) -> WitUgenInput {
        ...
        let freq = args
            .freq
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1200.0));
        let rq = args
            .rq
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.0));
    ...
    fn beat_track2(
        ...
        let windowsize = args
            .windowsize
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(2.0));
        let phaseaccuracy = args
            .phaseaccuracy
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.02));
        let lock = args
            .lock
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.0));
        let weightingscheme = args
            .weightingscheme
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(-2.1));
        let inputs: Vec<UGenInput> = vec![
            busindex,
            numfeatures,
            windowsize,
            phaseaccuracy,
    ...
    fn blip(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: BlipArgs) -> WitUgenInput {
        ...
        let numharm = args
            .numharm
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(200.0));
    ...
    fn buf_wr(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: BufWrArgs) -> WitUgenInput {
        let input_array: Vec<UGenInput> = args
            .input_array
            .into_iter()
            .map(ugen_input_from_wit)
            .collect();
    ...
    fn c_osc(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: COscArgs) -> WitUgenInput {
        ...
        let beats = args
            .beats
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.5));
    ...
    fn compander(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: CompanderArgs) -> WitUgenInput {
        ...
        let thresh = args
            ...
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.5));
        let slope_below = args
            .slope_below
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.0));
        let slope_above = args
            .slope_above
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.0));
        let clamp_time = args
        ...
        let relax_time = args
            .relax_time
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.1));
        let inputs: Vec<UGenInput> = vec![
            in_,
            control,
            thresh,
    ...
    fn convolution(
        ...
        let framesize = args
            .framesize
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(512.0));
    ...
    fn crackle(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: CrackleArgs) -> WitUgenInput {
        let chaos_param = args
            .chaos_param
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.5));
    ...
    fn cusp_l(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: CuspLArgs) -> WitUgenInput {
        let freq = args
            .freq
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(22050.0));
        let a = args
            .a
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.0));
        let b = args
            .b
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.9));
        let xi = args
            .xi
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.0));
    ...
    fn degree_to_key(
        ...
        let octave = args
            .octave
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(12.0));
    ...
    fn detect_silence(
        ...
        let amp = args
            .amp
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.0001));
        let time = args
            .time
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.1));
    ...
    fn disk_out(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: DiskOutArgs) -> WitUgenInput {
        let bufnum = ugen_input_from_wit(args.bufnum);
        let channels_array: Vec<UGenInput> = args
            .channels_array
            .into_iter()
            .map(ugen_input_from_wit)
            .collect();
    ...
    fn env_gen(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: EnvGenArgs) -> WitUgenInput {
        ...
        let action = args
            ...
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.0));
        let inputs: Vec<UGenInput> =
            vec![envelope, gate, level_scale, level_bias, time_scale, action];
    ...
    fn fb_sine_c(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: FbSineCArgs) -> WitUgenInput {
        ...
        let a = args
            .a
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.1));
        let c = args
            .c
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.5));
    ...
    fn formant(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: FormantArgs) -> WitUgenInput {
        ...
        let formfreq = args
            .formfreq
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1760.0));
        let bwfreq = args
            .bwfreq
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(880.0));
    ...
    fn free_self_when_done(
        def: SynthDefBorrow<'_>,
        ugen_rate: WitRate,
        args: FreeSelfWhenDoneArgs,
    ) -> WitUgenInput {
        let src = ugen_input_from_wit(args.src);
        let inputs: Vec<UGenInput> = vec![src];
    ...
    fn free_verb(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: FreeVerbArgs) -> WitUgenInput {
        ...
        let mix = args
            .mix
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.33));
        let room = args
            .room
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.5));
    ...
    fn g_verb(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: GVerbArgs) -> WitUgenInput {
        ...
        let roomsize = args
            .roomsize
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(10.0));
        let revtime = args
            .revtime
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(3.0));
        let damping = args
            .damping
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.5));
        ...
        let spread = args
            .spread
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(15.0));
        let drylevel = args
            .drylevel
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.0));
        let earlyreflevel = args
            .earlyreflevel
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.7));
        let taillevel = args
            .taillevel
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.5));
        let maxroomsize = args
            .maxroomsize
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(300.0));
        let inputs: Vec<UGenInput> = vec![
            in_,
            roomsize,
            revtime,
    ...
    fn gbman_l(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: GbmanLArgs) -> WitUgenInput {
        ...
        let xi = args
            .xi
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.2));
        let yi = args
            .yi
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(2.1));
    ...
    fn gendy1(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: Gendy1Args) -> WitUgenInput {
        ...
        let maxfreq = args
            .maxfreq
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(660.0));
        let ampscale = args
            .ampscale
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.5));
        ...
        let knum = args
            ...
            .unwrap_or(UGenInput::Constant(12.0));
        let inputs: Vec<UGenInput> = vec![
            ampdist, durdist, adparam, ddparam, minfreq, maxfreq, ampscale, durscale, init_cps,
            knum,
        ];
    ...
    fn gendy2(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: Gendy2Args) -> WitUgenInput {
        ...
        let a = args
            .a
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.17));
        let c = args
            .c
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.31));
        let inputs: Vec<UGenInput> = vec![
            ampdist, durdist, adparam, ddparam, minfreq, maxfreq, ampscale, durscale, init_cps,
            knum, a, c,
        ];
    ...
    fn gendy3(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: Gendy3Args) -> WitUgenInput {
        ...
        let knum = args
            ...
            .unwrap_or(UGenInput::Constant(12.0));
        let inputs: Vec<UGenInput> = vec![
            ampdist, durdist, adparam, ddparam, freq, ampscale, durscale, init_cps, knum,
        ];
    ...
    fn grain_buf(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: GrainBufArgs) -> WitUgenInput {
        ...
        let max_grains = args
            ...
            .unwrap_or(UGenInput::Constant(512.0));
        let inputs: Vec<UGenInput> = vec![
            trigger, dur, sndbuf, rate, pos, interp, pan, envbufnum, max_grains,
        ];
    ...
    fn grain_fm(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: GrainFmArgs) -> WitUgenInput {
        ...
        let max_grains = args
            ...
            .unwrap_or(UGenInput::Constant(512.0));
        let inputs: Vec<UGenInput> = vec![
            trigger, dur, car_freq, mod_freq, index, pan, envbufnum, max_grains,
        ];
    ...
    fn henon_c(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: HenonCArgs) -> WitUgenInput {
        ...
        let a = args
            .a
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.4));
        let b = args
            .b
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.3));
        let x0 = args
            .x0
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.0));
    ...
    fn i_rand(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: IRandArgs) -> WitUgenInput {
        ...
        let hi = args
            .hi
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(127.0));
        let inputs: Vec<UGenInput> = vec![lo, hi];
    ...
    fn lag_ud(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: LagUdArgs) -> WitUgenInput {
        let in_ = args
            ...
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.0));
        let lag_time_up = args
            .lag_time_up
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.1));
        let lag_time_down = args
            .lag_time_down
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.1));
    ...
    fn leak_dc(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: LeakDcArgs) -> WitUgenInput {
        ...
        let coef = args
            .coef
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.995));
        let inputs: Vec<UGenInput> = vec![in_, coef];
    ...
    fn lf_clip_noise(
        def: SynthDefBorrow<'_>,
        ugen_rate: WitRate,
        args: LfClipNoiseArgs,
    ) -> WitUgenInput {
        let freq = args
            .freq
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(500.0));
    ...
    fn lin_cong_c(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: LinCongCArgs) -> WitUgenInput {
        ...
        let c = args
            .c
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.13));
        let m = args
            .m
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.0));
    ...
    fn lorenz_l(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: LorenzLArgs) -> WitUgenInput {
        ...
        let r = args
            .r
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(28.0));
        let b = args
            .b
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(2.667));
        let h = args
            .h
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.05));
        let xi = args
            .xi
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.1));
    ...
    fn loudness(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: LoudnessArgs) -> WitUgenInput {
        ...
        let smask = args
            .smask
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.25));
        let tmask = args
            .tmask
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.0));
    ...
    fn mfcc(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: MfccArgs) -> WitUgenInput {
        ...
        let numcoeff = args
            .numcoeff
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(13.0));
    ...
    fn moog_ff(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: MoogFfArgs) -> WitUgenInput {
        ...
        let freq = args
            .freq
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(100.0));
        let gain = args
            .gain
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(2.0));
    ...
    fn onsets(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: OnsetsArgs) -> WitUgenInput {
        ...
        let medianspan = args
            .medianspan
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(11.0));
        let whtype = args
            .whtype
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.0));
        let rawodf = args
            ...
            .unwrap_or(UGenInput::Constant(0.0));
        let inputs: Vec<UGenInput> = vec![
            chain, threshold, odftype, relaxtime, floor, mingap, medianspan, whtype, rawodf,
        ];
    ...
    fn pause_self_when_done(
        def: SynthDefBorrow<'_>,
        ugen_rate: WitRate,
        args: PauseSelfWhenDoneArgs,
    ) -> WitUgenInput {
        let src = ugen_input_from_wit(args.src);
        let inputs: Vec<UGenInput> = vec![src];
    ...
    fn peak_follower(
        ...
        let decay = args
            .decay
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.999));
    ...
    fn pitch(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: PitchArgs) -> WitUgenInput {
        ...
        let min_freq = args
            .min_freq
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(60.0));
        let max_freq = args
            .max_freq
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(4000.0));
        let exec_freq = args
            .exec_freq
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(100.0));
        let max_bins_per_octave = args
            .max_bins_per_octave
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(16.0));
        let median = args
            .median
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.0));
        let amp_threshold = args
            .amp_threshold
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.01));
        let peak_threshold = args
            .peak_threshold
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.5));
        let down_sample = args
            .down_sample
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.0));
        let clar = args
    ...
    fn pitch_shift(
        ...
        let window_size = args
            ...
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.2));
        let pitch_ratio = args
            .pitch_ratio
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.0));
        let pitch_dispersion = args
            .pitch_dispersion
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.0));
        let time_dispersion = args
            .time_dispersion
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.0));
        let inputs: Vec<UGenInput> = vec![
    ...
    fn pv_hainsworth_foote(
        def: SynthDefBorrow<'_>,
        ugen_rate: WitRate,
        args: PvHainsworthFooteArgs,
    ) -> WitUgenInput {
        let buffer = ugen_input_from_wit(args.buffer);
        let proph = args
            .proph
        ...
        let wait_time = args
            .wait_time
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.04));
    ...
    fn pv_jensen_andersen(
        def: SynthDefBorrow<'_>,
        ugen_rate: WitRate,
        args: PvJensenAndersenArgs,
    ) -> WitUgenInput {
        let buffer = ugen_input_from_wit(args.buffer);
        let propsc = args
            .propsc
        ...
        let wait_time = args
            ...
            .unwrap_or(UGenInput::Constant(0.04));
        let inputs: Vec<UGenInput> = vec![
            buffer, propsc, prophfe, prophfc, propsf, threshold, wait_time,
        ];
    ...
    fn pv_phase_shift270(
        def: SynthDefBorrow<'_>,
        ugen_rate: WitRate,
        args: PvPhaseShift270Args,
    ) -> WitUgenInput {
        let buffer = ugen_input_from_wit(args.buffer);
        let inputs: Vec<UGenInput> = vec![buffer];
    ...
    fn quad_c(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: QuadCArgs) -> WitUgenInput {
        ...
        let c = args
            .c
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(-0.75));
        let xi = args
            .xi
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.0));
    ...
    fn rand_seed(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: RandSeedArgs) -> WitUgenInput {
        ...
        let seed = args
            .seed
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(56789.0));
    ...
    fn running_sum(
        ...
        let numsamp = args
            .numsamp
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(40.0));
    ...
    fn scope_out2(
        ...
        let max_frames = args
            .max_frames
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(4096.0));
        let scope_frames = args
            .scope_frames
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(4096.0));
        let mut inputs: Vec<UGenInput> = Vec::new();
    ...
    fn stepper(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: StepperArgs) -> WitUgenInput {
        ...
        let max = args
            .max
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(7.0));
        let step = args
            .step
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(1.0));
    ...
    fn stereo_convolution2_l(
        def: SynthDefBorrow<'_>,
        ugen_rate: WitRate,
        args: StereoConvolution2LArgs,
    ) -> WitUgenInput {
        let in_ = ugen_input_from_wit(args.in_);
    ...
    fn t_grains(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: TGrainsArgs) -> WitUgenInput {
        ...
        let interp = args
            .interp
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(4.0));
    ...
    fn trapezoid(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: TrapezoidArgs) -> WitUgenInput {
        ...
        let b = args
            .b
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.4));
        let c = args
            .c
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.6));
        let d = args
            .d
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.8));
    ...
    fn v_osc3(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: VOsc3Args) -> WitUgenInput {
        ...
        let freq1 = args
            .freq1
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(110.0));
        let freq2 = args
            .freq2
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(220.0));
        let freq3 = args
            .freq3
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(440.0));
    ...
    fn vibrato(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: VibratoArgs) -> WitUgenInput {
        ...
        let rate = args
            .rate
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(6.0));
        let depth = args
            .depth
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.02));
        ...
        let onset = args
            ...
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.0));
        let rate_variation = args
            .rate_variation
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.04));
        let depth_variation = args
            .depth_variation
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.1));
        let iphase = args
    ...
    fn warp1(def: SynthDefBorrow<'_>, ugen_rate: WitRate, args: Warp1Args) -> WitUgenInput {
        ...
        let overlaps = args
            .overlaps
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(8.0));
        let window_rand_ratio = args
            .window_rand_ratio
            .map(ugen_input_from_wit)
            .unwrap_or(UGenInput::Constant(0.0));
        let interp = args
