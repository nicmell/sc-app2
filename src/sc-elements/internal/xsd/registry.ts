...
// The specs are the single source for the attribute contract — the XSD and Rust
// validator specs are generated from them, and at runtime ScElement reads them
// via `getProp`. Collected with `import.meta.glob` (the
