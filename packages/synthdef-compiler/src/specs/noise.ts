...
export const UGENS: UGenRegistryEntry[] = [
  ...
  },
  {
    name: "Crackle",
    rates: ["audio", "control"],
    defaults: [{ name: "chaosParam", default: 1.5 }],
    numOutputs: null,
    extends: null,
  ...
  },
  {
    name: "Dust",
    rates: ["audio", "control"],
    defaults: [{ name: "density", default: 0 }],
    numOutputs: null,
    extends: null,
    summary: null,
    doc: "Generates random impulses from 0 to +1.",
    signalRange: null,
    argDocs: [{ name: "density", doc: "average number of impulses per second" }],
  },
  {
    name: "Dust2",
    rates: ["audio", "control"],
  ...
  },
  {
    name: "LFClipNoise",
    rates: ["audio", "control"],
    defaults: [{ name: "freq", default: 500 }],
    numOutputs: null,
    extends: null,
    summary: null,
    ...
    signalRange: null,
    argDocs: [{ name: "freq", doc: "approximate rate at which to generate random values." }],
  },
  {
    name: "LFDClipNoise",
    rates: ["audio", "control"],
    ...
    signalRange: null,
    argDocs: [{ name: "freq", doc: "rate at which to generate random values." }],
  },
  {
    name: "LFDNoise0",
    rates: ["audio", "control"],
