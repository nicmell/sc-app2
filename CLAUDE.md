...
- `CONDUCTOR.md` — the musical-time module (Italian, LANDED): the DAW
  header + two-way BPM metronome — verified scsynth/Strudel facts,
  the cps=0 pause mechanism, decisions and the implementation record.
